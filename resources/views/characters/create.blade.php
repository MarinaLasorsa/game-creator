            ...
            <div class="container">
                <form action="{{ route('characters.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" max="999" step="1" name="attack" class="form-control" id="attack" placeholder="inserisci il valore di attacco">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" max="999" step="1" name="defence" class="form-control" id="defence"
                            placeholder="inserisci il valore di difesa">
                    </div>
