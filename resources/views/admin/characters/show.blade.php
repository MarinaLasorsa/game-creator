            ...
            <div class="col-12 ">
                <div class="card-character-show">
                    ...
                    <div class="card-img-overlay bg-half-dark">
                        ...
                        <h1 class="card-title text-center text-orange p-3">
                            {{ $character->name }}
                            @auth
                                @if ($character->user_id === Auth::id())
                                    @if (count($character->users))
                                        @if ($character->users[0]->id == Auth::id())
                                            <a href="{{ route('admin.characters.toggleSelected', $character) }} " class="text-danger">&hearts;</a>
                                        @endif
                                    @else
                                        <a href="{{ route('admin.characters.toggleSelected', $character) }}" class="text-secondary">&hearts;</a>
                                    @endif
                                @endif
                            @endauth
                            </h1>
